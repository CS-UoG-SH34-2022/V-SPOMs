...
export const INTRODUCTION: introduct = {
    ...
    "content" : "V-SPOM is a web-based application for generating, editing and simulating SPOM networks. \
...
export const INTRO_DATA: intro[] = [
    {
        ...
        "content" : "SPOMs is short for: Spatial Patch Occupancy Models, which have developed out of classical ecological \
        ...
        "childrens":[
            {
                ...
                "content" : "They play a key role in population ecology and conservation planning."
            },
            {
                "title" : "Educational tool",
                "content": "We teach undergraduate students about these models in Level 4 \
            ...
            },
            {
                ...
                "content": "These ideas look complicated when written down, but in fact are quite simple, \
        ...
        "childrens":[
            {
                ...
                "content" : "The basic idea is that populations persist in a set of habitat \
                patches embedded in a matrix of less favourable habitat."
            },
            {
                "title" : "Binary occupation state",
                "content": "Patches are either occupied (colonized) or not, and transition \
                between being colonized and going locally extinct."
            },
            {
                "title" : "Determined by stochastic event balance",
                "content": "Regional persistence is determined by the balance of colonization \
                events and local extinction events."
            },
            {
                "title" : "Implicit spatial process",
                "content": "The process is 'implicitly' (rather than explicitly) spatial, \
        ...
        "childrens" : [
            {
                ...
                "content" : "Either Create a new scenario, or upload an existing \
                scenario (json file), restart the simulation then click start.",
            },
            {
                "title": "How to alter the SPOM functions?",
                "content": "Every scenario is unique and should have unique function \
            ...
            },
            {
                ...
                "content": "To adjust the simulation settings, locate the simulation controls at the bottom of \
            ...
            },
            {
                ...
                "content": "After the simulation has finished calculating, the spom will be ready to present the \
            ...
            },
            {
                ...
                "content" : "New patches can be added by enabling new patch addition \
            ...
            },
            {
                ...
                "content" : "When you are happy with your patch network, you can save it \
