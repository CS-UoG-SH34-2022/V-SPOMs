...
export class MolianenB2004 extends BaseConnectivityFunction{

    static DEFAULT_META = {"name": "Molianen 2004 B", "description": "Variant of Molianen 2004 connectivity function"};

    constructor(opt?:IConnectivitySettings){
        super(opt);
        this.meta = MolianenB2004.DEFAULT_META;
        this.type = ConnectivityType.MolianenB2004;
    }
